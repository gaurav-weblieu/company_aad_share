...
import com.company.companyadda.Pojo.CountryInfoPoJo;

public class CovidPojoModl {

    public String updated;
    public String country;
    public CountryInfoPoJo countryInfo;
    public String cases;
    ...
    public CountryInfoPoJo getCountryInfo() {
        return countryInfo;
    }

    public void setCountryInfo(CountryInfoPoJo countryInfo) {
