...
public class CompanyRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final CompanyResAdapter adapter = new CompanyResAdapter(this,getSupportFragmentManager(),
    ...
    public void noti(View view) {
        startActivity(new Intent(CompanyRegister.this,Notification.class));
