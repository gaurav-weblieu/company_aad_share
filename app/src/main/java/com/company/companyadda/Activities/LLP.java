...
import com.company.companyadda.Adapter.LLPAdapter;
import com.company.companyadda.R;
import com.google.android.material.tabs.TabLayout;

public class LLP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_llp);
        ...
        final LLPAdapter adapter = new LLPAdapter(this,getSupportFragmentManager(),
    ...
    public void noti(View view) {
        startActivity(new Intent(LLP.this,Notification.class));
