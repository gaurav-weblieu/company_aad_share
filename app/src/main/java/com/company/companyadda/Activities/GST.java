...
import com.company.companyadda.Adapter.GSTAdapter;
...
public class GST extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final GSTAdapter adapter = new GSTAdapter(this,getSupportFragmentManager(),
    ...
    public void noti(View view) {
        startActivity(new Intent(GST.this,Notification.class));
