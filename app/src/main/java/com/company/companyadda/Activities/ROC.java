...
import com.company.companyadda.Adapter.RocAdapter;
import com.company.companyadda.R;
import com.google.android.material.tabs.TabLayout;

public class ROC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final RocAdapter adapter = new RocAdapter(this,getSupportFragmentManager(),
    ...
    public void noti(View view) {
        startActivity(new Intent(ROC.this,Notification.class));
